  ...
  return (
    ...
    >
      <motion.div style={{ x: sx, y: sy }}>
        ...
        >
          {/* Halo */}
          <span className="absolute inset-0 rounded-full bg-[#0047BB]/30 blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

          {/* Button */}
          <span className="relative inline-flex items-center justify-center rounded-full bg-[#0047BB] text-white shadow-[0_12px_40px_rgba(0,71,187,0.45)] transition-colors duration-300 hover:bg-[#003A94] overflow-hidden">
